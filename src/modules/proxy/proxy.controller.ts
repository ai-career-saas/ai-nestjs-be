import { Controller, UseGuards, Post, UseInterceptors, Req, Body, UploadedFile } from "@nestjs/common";
...
export class ProxyController {
    ...
    async analyze(
        ...
        return forwardToFastAPI('/analyze', {
    ...
    async generateInterview(
        ...
        return forwardToFastAPI('/interview/generate', {
    ...
    async atsScore(
        ...
        return forwardToFastAPI('/ats/score', {
            job_description: body.job_description,
        }, file);
    }
    ...
    @Post('skill-upgrade')
    skillUpgrade(@Body() body: any) {
        return forwardToFastAPI('/skill-upgrade', {
            selected_career: body.selected_career,
        });
    }
}